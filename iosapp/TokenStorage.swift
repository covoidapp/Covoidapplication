...
let refreshTokenServiceName = "appid_refresh_token_"
...
public class TokenStorageManager {
    ...
    public func storeRefreshToken(token: String?) {
        save(key: refreshTokenServiceName + tenantId!, value: token)
    }
    ...
    public func loadStoredRefreshToken() -> String? {
        return load(key: refreshTokenServiceName + tenantId!)
    }
